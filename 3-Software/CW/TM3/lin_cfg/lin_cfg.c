...
const l_signal_handle LI0_response_error_signal = LI0_SensorError;
...
const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] ={
    ...
    { LIN_FRM_UNCD, 2, LIN_RES_PUB, 0, 0, 1   , (l_u8*)0 }

   ,{ LIN_FRM_UNCD, 2, LIN_RES_PUB, 2, 1, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 2, LIN_RES_PUB, 4, 2, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 2, LIN_RES_PUB, 6, 3, 1 , (l_u8*)0 }
...
const l_u8 lin_initial_NAD    =0x05;    /*<initial_NAD>*/
const lin_product_id product_id = {0x001E, 0x0002, 0x0001 };  /* {<supplier_id>,<function_id>,<variant>} */
const l_signal_handle response_error =  LI0_SensorError;
const l_u8 num_frame_have_esignal = 1;                                 /*number of frame contain error signal*/
const l_u16 lin_response_error_byte_offset[1] = {LIN_BYTE_OFFSET_LI0_SensorError};                  /*<interface_name>_< response_error>*/
const l_u8 lin_response_error_bit_offset[1] = {LIN_BIT_OFFSET_LI0_SensorError};                  /*<interface_name>_< response_error>*/
