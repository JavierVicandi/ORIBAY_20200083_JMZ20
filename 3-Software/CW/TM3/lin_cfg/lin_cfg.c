...
l_u8    lin_pFrameBuf[LIN_FRAME_BUF_SIZE] =
{
  ...
  0x00 /* 0 : 00000000 */ /* start of frame LI0_Humidity_f */

  ,0x00 /* 1 : 00000000 */


  ,0x00 /* 2 : 00000000 */ /* start of frame LI0_LuminosityA_f */

  ,0x00 /* 3 : 00000000 */
  

  ,0x00 /* 4 : 00000000 */ /* start of frame LI0_LuminosityB_f */

  ,0x00 /* 5 : 00000000 */
  

  ,0x00 /* 6 : 00000000 */ /* start of frame LI0_Temperature_f */

  ,0x00 /* 7 : 00000000 */
  

  ,0xfe /* 8 : 11111110 */ /* start of frame LI0_TestSensor_f */
...
l_u8    lin_flag_handle_tbl[LIN_FLAG_BUF_SIZE] =
{
  ...
  0xFF /* 0: start of flag frame LI0_Humidity_f */



  ,0xFF /* 1: start of flag frame LI0_LuminosityA_f */


  ,0xFF /* 2: start of flag frame LI0_LuminosityB_f */


  ,0xFF /* 3: start of flag frame LI0_Temperature_f */
...
const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] ={
   ...
   ,{ LIN_FRM_UNCD, 2, LIN_RES_SUB, 2, 1, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 2, LIN_RES_SUB, 4, 2, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 2, LIN_RES_SUB, 6, 3, 1 , (l_u8*)0 }
  
   ,{ LIN_FRM_UNCD, 3, LIN_RES_SUB, 8, 4, 1 , (l_u8*)0 }
...
l_u8 LI0_lin_configuration_RAM[LI0_LIN_SIZE_OF_CFG]= {0x00, 0x05, 0x0A, 0x12, 0x14, 0x16, 0x3C, 0x3D ,0xFF};


const l_u16  LI0_lin_configuration_ROM[LI0_LIN_SIZE_OF_CFG]= {0x0000, 0x05, 0x0A, 0x12, 0x14, 0x16, 0x3C, 0x3D ,0xFFFF};
...
const lin_schedule_data LI0_NormalTable_data[5] = {

   {LI0_Humidity_f, 3, 0}
  

   , {LI0_LuminosityA_f, 3, 0}
  
   , {LI0_LuminosityB_f, 3, 0}
  
   , {LI0_Temperature_f, 3, 0}
  
   , {LI0_TestSensor_f, 3, 0}
  
};

/******************** Schedule table Initialization ************************/
const lin_schedule_data LI0_InitTable_data[4] = {

   {LI0_MasterReq, 10, {0x05,0x06,0xB0,0x1E,0x00,0x02,0x00,0x05}}
  

   , {LI0_SlaveResp, 10, 0}
  
   , {LI0_MasterReq, 10, {0x05,0x06,0xB7,0x00,0x85,0xCA,0x92,0x14}}
  
   , {LI0_MasterReq, 10, {0x05,0x06,0xB7,0x04,0xD6,0xFF,0xFF,0xFF}}
  
};

/******************** Schedule table Initialization ************************/
const lin_schedule_data LI0_DiagnosticTable_data[2] = {
...
const lin_schedule_struct lin_schedule_tbl[LIN_NUM_OF_SCHD_TBL] ={
   ...
   ,{5, LIN_SCH_TBL_NORM  , &LI0_NormalTable_data[0] }
  
   ,{4, LIN_SCH_TBL_NORM  , &LI0_InitTable_data[0] }
  
   ,{2, LIN_SCH_TBL_NORM  , &LI0_DiagnosticTable_data[0] }
